    ...
    <div className="min-h-screen bg-[#FDFCFB]">
      ...
      <div className="h-48 bg-primary/5 flex items-center justify-center border-b border-primary/10 pt-16">
        <div className="text-center">
          <h1 className="text-4xl font-bold italic tracking-tighter">The Beauty Gallery</h1>
          <p className="text-xs uppercase tracking-[0.3em] opacity-50 mt-2">Curated for your specific skin ritual</p>
        </div>
      </div>
          ...
          <main className="flex-1">
            ...
            {products.length > 0 ? (
              ...
              <div className="h-96 flex flex-col items-center justify-center border-2 border-dashed border-base-200 rounded-[3rem]">
                <p className="text-xl italic opacity-30">No products match your current filters.</p>
                <button className="btn btn-link btn-primary no-underline mt-2">Clear All Filters</button>
              </div>
            )}
          </main>
        </div>
